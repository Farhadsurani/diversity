                ...
                <div class="row d-flex justify-content-between">
                    <div class="topbar-left">
                        <ul>
                            ...
                            <li><a href="{{ route('contact-us') }}"><i class="fa fa-envelope-o"></i>Support@website.com</a></li>
                        </ul>
                    </div>
                ...
                <div id="rev_slider_486_1" class="rev_slider fullwidthabanner" style="display:none;"
                    ...
                    <ul>    <!-- SLIDE  -->
                        <li data-index="rs-100"
                            ...
                            <!-- MAIN IMAGE -->
                            <img src="{{asset('public/images/slider/slide1.jpg')}}" alt=""
                            ...
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption Newspaper-Subtitle  content-scroll tp-resizeme"
                            ...
                            <!-- LAYER NR. 3 -->
                            <div class="tp-caption Newspaper-Subtitle tp-resizeme content-scroll"
                            ...
                            <div class="tp-caption Newspaper-Button rev-btn "
                                 ...
                                 style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:#ffd74f !important; border:0; border-radius:30px; margin-right:5px;">
                                READ MORE
                            </div>
                            <div class="tp-caption Newspaper-Button rev-btn"
                                 ...
                                 data-paddingbottom="[12,12,12,12]"
                                 data-paddingleft="[30,35,35,15]"
                                 style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px; padding-top: 3%;">
                        ...
                        <li data-index="rs-200"
                            ...
                            data-description="Science says that Women are generally happier">
                            <!-- MAIN IMAGE -->
                            <img src="{{asset('public/images/slider/slide2.jpg')}}" alt=""
                                 data-bgposition="center center"
                                 data-bgfit="cover"
                                 data-bgrepeat="no-repeat"
                                 data-bgparallax="10"
                            ...
                            <div class="tp-caption Newspaper-Subtitle   tp-resizeme"
                                 ...
                                 data-paddingbottom="[0,0,0,0]"
                                 data-paddingleft="[0,0,0,0]"
                                 style="z-index: 7; text-transform:capitalize; white-space: unset; color:#fff; font-family:rubik; font-size:18px; line-height:28px; font-weight:400;  overflow: scroll; width: 4px;">
                                {{$pages[2]->content}}
                            </div>
                            <!-- LAYER NR. 4 -->
                            <div class="tp-caption Newspaper-Button rev-btn "
                                 ...
                                 data-paddingbottom="[12,12,12,12]"
                                 data-paddingleft="[30,35,35,15]"
                                 style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; background-color:#ffd74f !important; border:0; border-radius:30px; margin-right:5px; padding-top: 3%;">
                                READ MORE
                            </div>
                            <div class="tp-caption Newspaper-Button rev-btn"
                                 ...
                                 data-paddingbottom="[12,12,12,12]"
                                 data-paddingleft="[30,35,35,15]"
                                 style="z-index: 8; white-space: nowrap; outline:none;box-shadow:none;box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;cursor:pointer; border-radius:30px; padding-top: 3%;"><a href="{{route('contact-us')}}">
                                CONTACT US
                                </a>
                            </div>
                        </li>
